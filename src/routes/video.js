...
const Video = require('../models/InMemoryVideo');

// Debug logging
console.log('s3Services:', Object.keys(s3Services));
console.log('videoUpload:', s3Services.videoUpload);

const { videoUpload, getPublicUrl, deleteFile } = s3Services;
